...
struct 경상대학교: UniversityModel {
    ...
    func pageURL(inCategory category: 경상대학교.Category, inPage page: Int, searchText text: String) throws -> URL {
    ...
    func postURL(inCategory category: 경상대학교.Category, uri link: String) throws -> URL {
